...
1. 개선이 필요한 섹션 및 지침에 대한 자세한 내용을 보려면 상단 메뉴 모음의 브랜드 유효성 검사 아이콘을 **[!UICONTROL 검토]** _또는_&#x200B;하여 _브랜드 유효성 검사 패널_&#x200B;을 여세요.
...
1. _브랜드 유효성 검사 패널_&#x200B;의 맨 위에서 화살표를 사용하여 각 변형을 탐색하고(예: 화살표를 사용하여 `Email 1`에서 `Email 2`(으)로 이동) 브랜드를 더 잘 준수하도록 섹션을 계속 수정하십시오.
