...
>[!TIP]
>
>GenStudio for Performance Marketters에서 데이터 수신을 시작하려면 채널 계정에 연결해야 합니다. [채널 계정 연결](connect-channel.md)을 참조하세요.
...
메타 광고를 사용하여 캠페인을 만들 때 비즈니스 목표에 부합하는 목표를 선택했을 수 있습니다. 성능 마케터를 위한 GenStudio에 표시되는 메타 광고의 6가지 목표가 있습니다.
...
| **[!UICONTROL 클릭수]** | 사용자가 링크 또는 광고와 같은 클릭 가능한 요소와 상호 작용하는 횟수입니다. | 클릭 수가 높으면 콘텐츠에 대한 높은 관심과 참여를 나타내므로 효과적인 적절한 대상자에게 도달할 수 있습니다. |
| **[!UICONTROL CTR]** | 이메일 내 광고, 검색 결과 또는 링크를 클릭한 사용자의 백분율(%)입니다.<br>**계산**: `clicks`을(를) `impressions`(으)로 나누기 | 클릭스루 비율이 높으면 컨텐츠가 메시징 및 디자인에서 대상자와 관련성이 높고 동기부여가 되며 대상자의 관심사를 효과적으로 타깃팅하고 있음을 나타냅니다. |
...
| **[!UICONTROL 비디오 재생]** | 비디오를 끝까지 시청한 시청자의 비율입니다. | 비디오 재생 횟수가 많으면 해당 비디오가 시선을 사로잡는 것으로 보일 수 있으며 썸네일, 제목 또는 배치가 효과적으로 시청자를 끌어당기고 있음을 의미할 수 있습니다. 높은 재생 완료율은 비디오 컨텐츠가 매력적이고 관련성이 있음을 나타냅니다. |
